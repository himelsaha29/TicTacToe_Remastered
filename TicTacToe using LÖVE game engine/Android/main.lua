...
function love.update(dt)
    if home then                         -- while on start screen
        ...
        --if next(love.touch.getTouches()) ~= nil then
            a = touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())
            b = touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
        ...
        local soundSX = --[[love.mouse.getX()]] touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())
        local soundSY = --[[love.mouse.getY()]] touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
    ...
    elseif player2Selected then -----------------------------------------------------------------------
        ...
        bX = --[[love.mouse.getX()]] touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())
        
        bY = --[[love.mouse.getY()]] touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
        local soundGX = --[[love.mouse.getX()]] touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())
        local soundGY = --[[love.mouse.getY()]] touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
        ...
        if temp <= 5 then
            --if next(love.touch.getTouches()) ~= nil then
                bufferX = --[[love.mouse.getX()]] touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())
                bufferY = --[[love.mouse.getY()]] touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
            --end
            temp = temp + 1
        else

            --if next(love.touch.getTouches()) ~= nil then
                xPos = --[[love.mouse.getX()]] touchPressedX * (VIRTUAL_WIDTH / love.graphics.getWidth())  -- scaling to fit phone display dimensions
                yPos = --[[love.mouse.getY()]] touchPressedY * (VIRTUAL_WIDTH / love.graphics.getWidth())
    ...
    elseif player1Selected then -----------------------------------------------------------------------
        ...
        --end
            ...
            -- cell lock and tie function WAS HERE
...
-- this function deals with the touch inputs
...
function love.draw()
    ...
    -- scale horizontally
    love.graphics.scale(love.graphics.getWidth() / (VIRTUAL_WIDTH)) -- changed
    ...
    elseif player2Selected then -----------------------------------------------------------------------
        ...
        --love.graphics.printf(string.format("%s",prnt), 40, VIRTUAL_HEIGHT - 50, VIRTUAL_WIDTH)
        --love.graphics.printf(string.format("%s",prnt2), 340, VIRTUAL_HEIGHT - 50, VIRTUAL_WIDTH)
        --love.graphics.printf(string.format("%s",bX), 340, VIRTUAL_HEIGHT, VIRTUAL_WIDTH)
        --love.graphics.printf(string.format("%s",bY), 140, VIRTUAL_HEIGHT, VIRTUAL_WIDTH)
    ...
    elseif player1Selected then -------------------------------------------------------------------------
        ...
        love.graphics.setFont(fonts['enterFont'])
        if player1 and player1Score ~= 5 and player2Score ~= 5 and continueShown == false then
            love.graphics.printf(string.format("%s",serve), 66, VIRTUAL_HEIGHT - 160, VIRTUAL_WIDTH)
        elseif player2 and player1Score ~= 5 and player2Score ~= 5 and continueShown == false then
